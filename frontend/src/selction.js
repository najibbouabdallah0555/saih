...
function Selection({ onFilterChange }) {
  ...
  return (
    <div className="selection-filter mb-[450px]">
      <h1 className="text-center text-6xl font-bold mt-0">استكشف عروض الوكالات حسب التفاصيل</h1>
      <section className="bg-[rgb(0,176,176)] mt-20 mb-10 rounded-3xl overflow-hidden mx-auto max-w-7xl h-min w-full flex flex-col p-0 items-center ">
        <div className="w-full h-min p-0">
          <TourSlider />
        </div>
      </section>
      <h1 className="text-4xl text-center font-bold my-4">عروض الوكالات السياحية</h1>
      ...
      {/* عرض العروض المفلترة */}
      <div className="filtered-offers mt-8">
