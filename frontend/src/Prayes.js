...
const Prayes = () => {
    ...
    const icons =[(<MdAccessTimeFilled />
    ),(<IoIosCompass />)];
    ...
    const Offers = {
      "1": { "name": "مواقيت الصلاة", "Link": "Salat" },
      "2": { "name": "القبلة", "Link": "Qibla" },
    }
  ...
  return (
    <div className="bg-[rgb(0,176,176)] w-full h-screen flex flex-col justify-center items-center">
        ...
        <h1 className='text-center text-7xl w-min font-bold mb-20 lg:my-20 md:text-gray-700 z-20'>عبادات</h1>
        <div className='w-full max-w-7xl h-max bg-gray-100 rounded-3xl flex-row flex justify-center items-center py-10'>
